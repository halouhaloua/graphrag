...
Revision ID: 4cfc2f527944
Revises: 
Create Date: 2026-05-02 17:20:52.630787
...
def upgrade() -> None:
    ...
    sa.Column('api_content_type', sa.String(length=50), nullable=True, comment='Content-Type，raw模式时使用'),
