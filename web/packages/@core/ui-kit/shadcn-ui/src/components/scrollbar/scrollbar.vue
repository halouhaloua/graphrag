...
<template>
  ...
  >
    <div
      ...
      class="scrollbar-top-shadow pointer-events-none absolute top-0 z-10 h-12 w-full rounded-[8px] opacity-0 transition-opacity duration-300 ease-in-out will-change-[opacity]"
    ></div>
    <slot></slot>
    <div
      ...
      class="scrollbar-bottom-shadow pointer-events-none absolute bottom-0 z-10 h-12 rounded-[8px] w-full opacity-0 transition-opacity duration-300 ease-in-out will-change-[opacity]"
    ></div>
    <ScrollBar
      v-if="horizontal"
