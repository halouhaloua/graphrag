...
const copyrightPoliceIcp = defineModel<string>('copyrightPoliceIcp');
const copyrightPoliceIcpLink = defineModel<string>('copyrightPoliceIcpLink');
const copyrightLoginOnly = defineModel<boolean>('copyrightLoginOnly');
...
<template>
  ...
  <SwitchItem v-model="copyrightLoginOnly" :disabled="itemDisabled">
    {{ $t('preferences.copyright.loginOnly') }}
  </SwitchItem>
  ...
  <InputItem v-model="copyrightPoliceIcp" :disabled="itemDisabled">
    {{ $t('preferences.copyright.policeIcp') }}
  </InputItem>
  <InputItem v-model="copyrightPoliceIcpLink" :disabled="itemDisabled">
    {{ $t('preferences.copyright.policeIcpLink') }}
  </InputItem>
</template>
