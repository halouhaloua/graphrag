...
<template>
  ...
  >
    ...
    <!-- 底部版权信息 -->
    <div
      v-if="copyright && preferences.copyright.enable"
      class="text-muted-foreground absolute inset-x-0 bottom-3 z-10 flex justify-center text-center text-xs"
    >
      <slot name="copyright">
        <Copyright v-bind="preferences.copyright" />
      </slot>
    </div>
  </div>
</template>
