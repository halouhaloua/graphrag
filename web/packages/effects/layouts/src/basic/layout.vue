...
<template>
  <VbenAdminLayout
    ...
    :sidebar-branding="preferences.widget.sidebarBranding"
  ...
  >
    ...
    <!-- 页脚 -->
    <template v-if="preferences.footer.enable && !(preferences.copyright.enable && preferences.copyright.loginOnly)" #footer>
      <LayoutFooter>
        <Copyright
