   ...
   */
  {
    ...
    children: [
      ...
      // AI平台 - 流程编排
      {
        ...
        meta: { hideInMenu: true, title: '流程编排', activePath: '/ai-platform/workflow' },
      },
      // AI平台 - 团队管理
      {
        name: 'AiWorkflowTeam',
        ...
        meta: { hideInMenu: true, title: '团队管理', activePath: '/ai-platform/team' },
      },
    ],
  },
