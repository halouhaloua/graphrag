...
export interface ParamBinding {
  paramName: string; // 数据源参数名（对应 SQL 的 :param 或 API 的 {param}）
  globalKey: string; // 全局参数 key（筛选器的 paramKey）
}
...
export interface DataSourceConfig {
  ...
  paramBindings?: ParamBinding[]; // 参数绑定（全局筛选器 -> 数据源参数）
  // 刷新配置
...
// 预定义组件材料 - 使用函数形式以支持动态语言切换
export function getWidgetMaterials(): WidgetMaterial[] {
  return [
    // 数据展示
    {
      type: 'stat-card',
        ...
        seriesData: [
          {
            ...
            data: [
              820, 932, 901, 934, 1290, 1330, 1320, 1450, 1200, 1100, 1350,
              1500,
            ],
          },
          {
    ...
    },
    {
      ...
      defaultProps: {
        ...
        seriesData: [
          ...
          {
            name: $t('dashboard-design.material.defaultProps.emailMarketing'),
            value: 580,
          },
          {
            name: $t('dashboard-design.material.defaultProps.unionAds'),
            value: 484,
          },
          {
            name: $t('dashboard-design.material.defaultProps.videoAds'),
            value: 300,
          },
        ],
      },
    ...
    },
    {
      ...
      defaultProps: {
        ...
        indicators: [
          {
            name: $t('dashboard-design.material.defaultProps.sales'),
            max: 100,
          },
        ...
        seriesData: [
          {
            name: $t('dashboard-design.material.defaultProps.budget'),
            value: [85, 90, 80, 70, 75, 88],
          },
          {
            name: $t('dashboard-design.material.defaultProps.actual'),
            value: [90, 85, 95, 80, 70, 92],
          },
        ],
      },
    },
    ...
    },
    {
      ...
      defaultProps: {
        ...
        seriesData: [
          {
            name: $t('dashboard-design.material.defaultProps.salesVolume'),
            value: 85,
            max: 100,
          },
          {
            name: $t('dashboard-design.material.defaultProps.orderVolume'),
            value: 72,
            max: 100,
          },
          {
            name: $t('dashboard-design.material.defaultProps.customerCount'),
            value: 93,
            max: 100,
          },
        ],
    ...
    },
    {
      ...
      defaultProps: {
        ...
        links: [
          {
            source: $t('dashboard-design.material.defaultProps.visit'),
            target: $t('dashboard-design.material.defaultProps.searchEngine'),
            value: 500,
          },
          {
            source: $t('dashboard-design.material.defaultProps.visit'),
            target: $t('dashboard-design.material.defaultProps.directAccess'),
            value: 300,
          },
          {
            source: $t('dashboard-design.material.defaultProps.visit'),
            target: $t('dashboard-design.material.defaultProps.consult'),
            value: 200,
          },
          {
            source: $t('dashboard-design.material.defaultProps.searchEngine'),
            target: $t('dashboard-design.material.defaultProps.intent'),
            value: 300,
          },
          {
            source: $t('dashboard-design.material.defaultProps.directAccess'),
            target: $t('dashboard-design.material.defaultProps.intent'),
            value: 200,
          },
          {
            source: $t('dashboard-design.material.defaultProps.consult'),
            target: $t('dashboard-design.material.defaultProps.order'),
            value: 150,
          },
          {
            source: $t('dashboard-design.material.defaultProps.order'),
            target: $t('dashboard-design.material.defaultProps.deal'),
            value: 400,
          },
        ],
      },
    ...
    // 列表
    {
      ...
      defaultProps: {
        ...
        items: [
          {
            id: '1',
            title: $t('dashboard-design.material.defaultProps.todoItem1'),
            done: false,
            priority: 'high',
          },
          {
            id: '2',
            title: $t('dashboard-design.material.defaultProps.todoItem2'),
            done: true,
            priority: 'medium',
          },
          {
            id: '3',
            title: $t('dashboard-design.material.defaultProps.todoItem3'),
            done: false,
            priority: 'low',
          },
        ],
    ...
    // 快捷入口（归类到列表）
    {
      ...
      defaultProps: {
        title:
          $t('dashboard-design.attribute.widget.quickLinks.title') ||
          '快捷入口',
        columns: 4,
        rows: 2,
        menus: [],
    ...
    },
    {
      ...
      defaultProps: {
        ...
        columns: [
          {
            prop: 'name',
            label: $t('dashboard-design.attribute.placeholder.name'),
            minWidth: 120,
          },
          {
            prop: 'value',
          ...
          {
            prop: 'status',
            label: $t('dashboard-design.attribute.status'),
            minWidth: 80,
          },
          {
            prop: 'time',
            label: $t('dashboard-design.fieldLabels.time'),
            minWidth: 150,
          },
        ],
        data: [
    ...
    {
      type: 'form-render',
      title: $t('dashboard-design.material.widgets.formRender'),
      icon: 'ListChecks',
      category: 'list',
      defaultW: 12,
      defaultH: 8,
      ...
      minH: 4,
      defaultProps: {
        title: $t('dashboard-design.material.defaultProps.formRender'),
        formCode: '',
      },
    },
    {
      type: 'approval-center',
      title: $t('dashboard-design.material.widgets.approvalCenter'),
      icon: 'Stamp',
      category: 'list',
      defaultW: 12,
      defaultH: 3,
      ...
      minH: 2,
      defaultProps: {
        title: $t('dashboard-design.material.defaultProps.approvalCenter'),
        showMore: true,
    ...
    {
      type: 'my-apps',
      title: $t('dashboard-design.material.widgets.myApps'),
      icon: 'LayoutGrid',
      category: 'list',
      defaultW: 12,
      defaultH: 3,
      ...
      minH: 2,
      defaultProps: {
        title: $t('dashboard-design.material.defaultProps.myApps'),
        showMore: false,
        maxCount: 8,
      },
    },
    {
      type: 'server-monitor',
      title: $t('dashboard-design.material.widgets.serverMonitor'),
      icon: 'Monitor',
      category: 'list',
      defaultW: 12,
      defaultH: 3,
      ...
      minH: 2,
      defaultProps: {
        title: $t('dashboard-design.material.defaultProps.serverMonitor'),
    ...
    {
      type: 'filter-input',
      title: $t('dashboard-design.material.widgets.filterInput'),
      icon: 'Search',
      category: 'filter',
      defaultW: 3,
      defaultH: 1,
      ...
      defaultProps: {
        title: '',
        paramKey: '',
        label: $t('dashboard-design.material.defaultProps.filterInput'),
        placeholder: $t('dashboard-design.material.defaultProps.filterInputPlaceholder'),
        defaultValue: '',
        labelPosition: 'left',
        labelWidth: 80,
        labelAlign: 'right',
    ...
    {
      type: 'filter-select',
      title: $t('dashboard-design.material.widgets.filterSelect'),
      icon: 'ListFilter',
      category: 'filter',
      defaultW: 3,
      defaultH: 1,
      ...
      defaultProps: {
        title: '',
        paramKey: '',
        label: $t('dashboard-design.material.defaultProps.filterSelect'),
        placeholder: $t('dashboard-design.material.defaultProps.filterSelectPlaceholder'),
        defaultValue: '',
        multiple: false,
        clearable: true,
        optionSource: 'static',
        options: [],
        optionDataSourceCode: '',
    ...
    {
      type: 'filter-date',
      title: $t('dashboard-design.material.widgets.filterDate'),
      icon: 'CalendarDays',
      category: 'filter',
      defaultW: 3,
      defaultH: 1,
      ...
      defaultProps: {
        title: '',
        paramKey: '',
        label: $t('dashboard-design.material.defaultProps.filterDate'),
        placeholder: $t('dashboard-design.material.defaultProps.filterDatePlaceholder'),
        defaultValue: '',
    ...
    },
    {
      ...
      title: $t('dashboard-design.material.widgets.filterDateRange'),
      icon: 'CalendarRange',
      category: 'filter',
      defaultW: 4,
      defaultH: 1,
      ...
      defaultProps: {
        ...
        startParamKey: '',
        endParamKey: '',
        label: $t('dashboard-design.material.defaultProps.filterDateRange'),
        startPlaceholder: $t('dashboard-design.material.defaultProps.filterStartDate'),
        endPlaceholder: $t('dashboard-design.material.defaultProps.filterEndDate'),
        defaultValue: [],
        dateFormat: 'YYYY-MM-DD',
        labelPosition: 'left',
        labelWidth: 80,
...
// 为了向后兼容，保留 widgetMaterials 作为 getter（已废弃，请使用 getWidgetMaterials()）
export const widgetMaterials = getWidgetMaterials;
...
export const useDashboardDesignStore = defineStore('dashboard-design', () => {
  ...
  // 收集画布中所有筛选器的 paramKey
  const allFilterParamKeys = computed(() => {
    const keys: string[] = [];
    for (const w of dashboardConfig.value.widgets) {
      if (w.type.startsWith('filter-')) {
        if (w.type === 'filter-date-range') {
          if (w.props.startParamKey) keys.push(w.props.startParamKey);
          if (w.props.endParamKey) keys.push(w.props.endParamKey);
        } else if (w.props.paramKey) {
          keys.push(w.props.paramKey);
        }
      }
    }
    return [...new Set(keys)];
  ...
  // 收集画布中所有数据组件的参数绑定中引用的 globalKey
  const allBoundGlobalKeys = computed(() => {
    const keys: string[] = [];
    for (const w of dashboardConfig.value.widgets) {
      if (w.dataSource?.paramBindings) {
        for (const b of w.dataSource.paramBindings) {
          if (b.globalKey) keys.push(b.globalKey);
        }
      }
    }
    return [...new Set(keys)];
